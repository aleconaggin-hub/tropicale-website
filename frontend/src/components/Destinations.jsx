...
const API = null; // static — no backend
...
export const Destinations = () => {
  ...
  }, [activeCategory, activeContinent, search]);
    ...
    <section id="servicos" data-testid="destinations-section" className="relative bg-cream py-24 lg:py-32">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-12 gap-8 items-end mb-14 lg:mb-20">
          ...
          <div className="lg:col-span-4 lg:justify-self-end">
            <p className="text-navy/75 max-w-sm leading-relaxed">
              Roteiros do Brasil ao Pacífico Sul — todos personalizáveis. Filtre por estilo ou continente para inspirar sua próxima viagem.
            </p>
          </div>
        </div>
        ...
        <div
          ...
          key={`${activeCategory}-${activeContinent}-${search}`}
        >
          {visible.map((d) => (
